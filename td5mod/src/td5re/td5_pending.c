...
static const char *const k_seed[] = {
    ...
    "Arcade NITRO: speed-trail particles + 1.5x top speed while active",
    "Arcade GHOST: can't be newly acquired as a cop-chase target",
    "Arcade INDESTRUCTIBLE (was WRECK): common, damage-gated",
