...
static const char *const k_seed[] = {
    "End-of-race transition is opaque; race doesn't bleed through RESULTS",
    "START/FINISH banners + track signs render solid, not 50% see-through",
    "PENDING TO TEST screen opens with no modal; ENTER on a row opens details",
