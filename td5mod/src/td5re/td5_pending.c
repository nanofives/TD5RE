...
static const char *const k_seed[] = {
    ...
    "Tutorial overlay: first-race Xbox pad diagram; labels read bindings; any button dismisses; shows once",
    "Tutorial overlay: TutorialOverlay=2 forces it every race; =0 off; never in MP/replay/trace",
