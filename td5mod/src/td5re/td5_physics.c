...
/* Per-slot previous-frame grounded bitmask (1=grounded). CORE wheel-contact
 * bookkeeping: snapshotted pre-refresh in the suspension response, read by the
 * V2V ram check and landing detection. (Stayed here in the P1-B split.) */
