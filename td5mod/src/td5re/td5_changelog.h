...
static const TD5_ChangelogLine k_changelog_lines[] = {
    ...
    { CL_ITEM,    "RT LIGHTING: cars now keep a grounding shadow in dark," },
    { CL_ITEM,    "  evening and overcast settings instead of looking" },
    { CL_ITEM,    "  pasted-on (soft blob fallback + shadow floor)." },
