...
static const TD5_ChangelogLine k_changelog_lines[] = {
    ...
    { CL_ITEM,    "  built in about a third of a second and the race" },
    { CL_ITEM,    "  starts; the buildings, trees and bridges are then" },
    { CL_ITEM,    "  filled in on a background thread while you drive," },
    { CL_ITEM,    "  about 6-12x faster than you can reach them." },
    { CL_ITEM,    "  Before, the wait was around 21 seconds." },
    ...
    { CL_ITEM,    "FIX: the track preview in AUTO TRACK STUDIO was drawing" },
    { CL_ITEM,    "  a slightly different route from the one you would" },
    { CL_ITEM,    "  actually race, because background threads did not" },
    { CL_ITEM,    "  inherit the game's floating-point rounding mode." },
    { CL_BLANK,   "" },
