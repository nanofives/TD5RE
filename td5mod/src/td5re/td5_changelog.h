...
static const TD5_ChangelogLine k_changelog_lines[] = {
    ...
    { CL_ITEM,    "  - a dimmed Xbox pad diagram with an arrow from each" },
    { CL_ITEM,    "  button to what it does (read from your bindings)." },
    { CL_ITEM,    "  Press any button to start; it won't show again" },
    { CL_ITEM,    "  (toggle via the TutorialOverlay option)" },
