...
static const TD5_ChangelogLine k_changelog_lines[] = {
    ...
    { CL_ITEM,    "FIX (arcade power-ups): on 2-lane roads boxes bunched" },
    { CL_ITEM,    "  into a single lane; they now alternate across both" },
    { CL_ITEM,    "  drivable lanes (and avoid verge/grass lanes)." },
