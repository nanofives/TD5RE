...
static const TD5_ChangelogLine k_changelog_lines[] = {
    ...
    { CL_ITEM,    "SOUND OPTIONS now shows the SFX, music and radio" },
    { CL_ITEM,    "  levels as a number, not just a bar." },
    ...
    { CL_ITEM,    "  shows the URL format and rejects a bad address." },
