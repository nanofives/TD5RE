...
static const TD5_ChangelogLine k_changelog_lines[] = {
    ...
    { CL_ITEM,    "Drag Race options gained LANES (2-8) and TRAFFIC, so a" },
    { CL_ITEM,    "  solo drag can be a wide multi-lane run with oncoming" },
    { CL_ITEM,    "  cars - same controls the multiplayer drag mode had." },
