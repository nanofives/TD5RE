...
static const TD5_ChangelogLine k_changelog_lines[] = {
    ...
    { CL_ITEM,    "Splitscreen: a gold crown now marks the HOST's" },
    { CL_ITEM,    "  profile on the player-select / car-select screens" },
    { CL_ITEM,    "  so you can see who's host after everyone picks" },
