 ...
 * the decision outright. MEASURED: the scenery generator run on an
 * unsynchronised worker produced a MODELS.DAT 492 bytes different from the
 * same seed built on the main thread.
 *
