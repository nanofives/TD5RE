 ...
 *     td5_radio_init("http://ice1.somafm.com/beatblender-128-mp3");
...
/* Initialise the radio backend with a stream URL (UTF-8). Does NOT connect yet
 * -- the worker connects lazily on the first td5_music_play(). Idempotent. */
