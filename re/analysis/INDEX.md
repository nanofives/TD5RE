...
- [actor_struct_gap_audit_2026-05-20.md](archive/actor_struct_gap_audit_2026-05-20.md) — TD5_Actor struct 18-gap audit (0x388-stride field resolution)
...
- [da_t2_update_actor_track_pos.md](archive/wave4_deep_audits/da_t2_update_actor_track_pos.md) — deep audit UpdateActorTrackPosition 0x004440F0 (extends pilot D1-D7 with D8-D10)
- [da_t2_fix1_case1_fwd_staged.md](archive/wave4_deep_audits/da_t2_fix1_case1_fwd_staged.md) — DA-T2 fix 1 case 1 (FWD) secondary tests, STAGED not applied
...
- [tire_marks_burnout_investigation_handoff_2026-05-29.md](archive/tire_marks_burnout_investigation_handoff_2026-05-29.md) — tire marks / burnout smoke investigation handoff
- [advance_texture_streaming_scheduler_reaudit_2026-05-24.md](archive/advance_texture_streaming_scheduler_reaudit_2026-05-24.md) — AdvanceTextureStreamingScheduler (0x0040b830) re-audit
- [da_t1_clip_and_submit.md](archive/wave4_deep_audits/da_t1_clip_and_submit.md) — deep audit ClipAndSubmitProjectedPolygon (0x004317F0)
...
- [frontend_fade_sfx_universal_s03.md](archive/frontend_fade_sfx_universal_s03.md) — transition fade SFX universal coverage (S03, 2026-06-04)
- [frontend_master_fix_plan.md](archive/frontend_master_fix_plan.md) — master faithfulness fix plan (2026-06-01)
- [frontend_diff_blindspot_postmortem.md](archive/frontend_diff_blindspot_postmortem.md) — DIFF blind-spot post-mortem (2026-06-01)
- [frontend_fix_plan.md](archive/frontend_fix_plan.md) — faithfulness master fix plan, first cut (2026-05-31)
- [frontend_re_methodology_postmortem.md](archive/frontend_re_methodology_postmortem.md) — frontend RE methodology post-mortem (2026-05-30)
- [frontend_complete_spec.md](archive/frontend_complete_spec.md) — complete element & behavior spec (corrected-methodology read)
- [frontend_screen_layout_spec.md](archive/frontend_screen_layout_spec.md) — exact element positions from TD5_d3d.exe
- [frontend_behavior_parity_report.md](archive/frontend_behavior_parity_report.md) — button & element behavior parity report
- [frontend_flow_model.md](archive/frontend_flow_model.md) — flow / dispatch / state / persistence behavior model
- [frontend_rendering_model.md](archive/frontend_rendering_model.md) — frontend rendering model (behavior-level RE)
- [frontend_call_graph_closure.md](archive/frontend_call_graph_closure.md) — provably-complete call-graph closure of the frontend subsystem
- [frontend_assumption_register.md](archive/frontend_assumption_register.md) — assumption register for the frontend port
- [frontend_font_atlas_resolution.md](archive/frontend_font_atlas_resolution.md) — font atlas resolution
- [frontend_snk_strings.md](archive/frontend_snk_strings.md) — Language.dll SNK_* frontend label string extraction
- [plan_screen24_race_results_parity.md](plan_screen24_race_results_parity.md) — Screen [24] RaceResults parity plan
- [screens_00.md](archive/frontend_screens/screens_00.md) — per-screen element + behavior spec, screens 0-4
- [screens_05.md](archive/frontend_screens/screens_05.md) — per-screen element + behavior spec, screens 5-9
- [screens_10.md](archive/frontend_screens/screens_10.md) — per-screen element + behavior spec, screens 10-14
- [screens_15.md](archive/frontend_screens/screens_15.md) — per-screen element + behavior spec, screens 15-19
- [screens_20.md](archive/frontend_screens/screens_20.md) — per-screen element + behavior spec, screens 20-24
- [screens_25.md](archive/frontend_screens/screens_25.md) — per-screen element + behavior spec, screens 25-29
- [part_00.md](archive/frontend_layout/part_00.md) — layout harvest, screen-table indices 0-4
- [part_05.md](archive/frontend_layout/part_05.md) — layout harvest, indices 5-9
- [part_10.md](archive/frontend_layout/part_10.md) — layout harvest, indices 10-14
- [part_15.md](archive/frontend_layout/part_15.md) — layout harvest, indices 15-19
- [part_20.md](archive/frontend_layout/part_20.md) — layout harvest, indices 20-24
- [part_25.md](archive/frontend_layout/part_25.md) — layout harvest, indices 25-29
- [behavior_00.md](archive/frontend_layout/behavior_00.md) — behavior + parity harvest, indices 0-4
- [behavior_05.md](archive/frontend_layout/behavior_05.md) — behavior harvest, indices 5-9
- [behavior_10.md](archive/frontend_layout/behavior_10.md) — behavior harvest, indices 10-14
- [behavior_15.md](archive/frontend_layout/behavior_15.md) — behavior harvest, indices 15-19
- [behavior_20.md](archive/frontend_layout/behavior_20.md) — behavior + port-parity harvest, indices 20-24
- [behavior_25.md](archive/frontend_layout/behavior_25.md) — behavior harvest, indices 25-29
- [diff_00.md](archive/frontend_diff/diff_00.md) — PORT-vs-ORIGINAL diff, screens 0-4
- [diff_05.md](archive/frontend_diff/diff_05.md) — PORT-vs-ORIGINAL diff, screens 5-9
- [diff_10.md](archive/frontend_diff/diff_10.md) — PORT-vs-ORIGINAL diff, screens 10-14
- [diff_15.md](archive/frontend_diff/diff_15.md) — PORT-vs-ORIGINAL diff, screens 15-19
- [diff_20.md](archive/frontend_diff/diff_20.md) — PORT-vs-ORIGINAL diff, screens 20-24
- [diff_25.md](archive/frontend_diff/diff_25.md) — PORT-vs-ORIGINAL diff, screens 25-29
- [fix_00.md](archive/frontend_fixlist/fix_00.md) — 3-layer faithfulness fix list, screens 0-4
- [fix_05.md](archive/frontend_fixlist/fix_05.md) — 3-layer faithfulness fix list, screens 5-9
- [fix_10.md](archive/frontend_fixlist/fix_10.md) — 3-layer faithfulness fix list, screens 10-14
- [fix_15.md](archive/frontend_fixlist/fix_15.md) — 3-layer faithfulness fix list, screens 15-19
- [fix_20.md](archive/frontend_fixlist/fix_20.md) — 3-layer faithfulness fix list, screens 20-24
- [fix_25.md](archive/frontend_fixlist/fix_25.md) — 3-layer faithfulness fix list, screens 25-29
...
- [da_t3_race_hud_layout.md](archive/wave4_deep_audits/da_t3_race_hud_layout.md) — deep audit InitializeRaceHudLayout (0x00437BA0), ARCH-DIVERGENCE promotion
- [da_t4_race_type_category.md](archive/wave4_deep_audits/da_t4_race_type_category.md) — deep audit RaceTypeCategoryMenuStateMachine (0x004168B0)
- [da_t5_radial_pulse.md](archive/wave4_deep_audits/da_t5_radial_pulse.md) — deep audit RenderHudRadialPulseOverlay (0x00439E60)

## Audio

- [sound-system-deep-dive.md](subsystems/sound-system-deep-dive.md) — sound system deep dive (DXSound, vehicle audio, CD)
- [da_m3_dxsound_polyphony.md](archive/wave4_deep_audits/da_m3_dxsound_polyphony.md) — M2DX DXSound polyphony deep audit
...
- [da_m2_dxplay_lockstep.md](archive/wave4_deep_audits/da_m2_dxplay_lockstep.md) — DXPlay lockstep / pad-replication wire protocol audit
...
- [da_m1_replay_codec.md](archive/wave4_deep_audits/da_m1_replay_codec.md) — M2DX replay codec deep audit
...
- [split_screen_perf_diagnostic_2026-06-08.md](archive/split_screen_perf_diagnostic_2026-06-08.md) — split-screen render perf: per-draw Map(WRITE_DISCARD) GPU-serialization stall
- [multithreading_architecture_plan_2026-06-08.md](archive/multithreading_architecture_plan_2026-06-08.md) — multithreading architecture design plan (job pool, parallel decode, render re-entrancy)
- [pageheap_findings_2026-05-20.md](archive/pageheap_findings_2026-05-20.md) — PageHeap audit on TD5_d3d.exe, first finding
...
- [cannot_determine_investigation_2026-05-24.md](archive/cannot_determine_investigation_2026-05-24.md) — CANNOT_DETERMINE verdict rows re-investigated
- [intentional_resampling_2026-05-24.md](archive/intentional_resampling_2026-05-24.md) — re-sample of 25/310 INTENTIONAL verdicts for lazy classification
- [not_ported_triage_2026-05-24.md](archive/not_ported_triage_2026-05-24.md) — NOT_PORTED verdict triage
- [oversight_triage_2026-05-24.md](archive/oversight_triage_2026-05-24.md) — OVERSIGHT triage: 10 new bugs
...
- [fpu_pc64_fwrapv_ab_measurement_2026-05-20.md](archive/fpu_pc64_fwrapv_ab_measurement_2026-05-20.md) — A/B measurement of FPU PC=64 + -fwrapv on whole-state diff
- [imul_wrapv_audit_2026-05-20.md](archive/imul_wrapv_audit_2026-05-20.md) — IMUL signed-overflow audit of port build flags
- [sar_audit_2026-05-20.md](archive/sar_audit_2026-05-20.md) — SAR vs SHR semantic audit
...
- [pilot_00403720_audit.md](archive/pilot_00403720_audit.md) — RefreshVehicleWheelContactFrames (0x00403720)
- [pilot_00403720_runbook.md](archive/pilot_00403720_runbook.md) — RefreshVehicleWheelContactFrames runbook
- [pilot_00403A20_audit.md](archive/pilot_00403A20_audit.md) — IntegrateWheelSuspensionTravel (0x00403A20)
- [pilot_00403D90_audit.md](archive/pilot_00403D90_audit.md) — UpdateVehicleState0fDamping (0x00403D90)
- [pilot_00403D90_runbook.md](archive/pilot_00403D90_runbook.md) — UpdateVehicleState0fDamping runbook
- [pilot_00404030_audit.md](archive/pilot_00404030_audit.md) — UpdatePlayerVehicleDynamics (0x00404030)
- [pilot_00404EC0_audit.md](archive/pilot_00404EC0_audit.md) — UpdateAIVehicleDynamics (0x00404EC0)
- [pilot_004057F0_audit.md](archive/pilot_004057F0_audit.md) — UpdateVehicleSuspensionResponse (0x004057F0)
- [pilot_00405B40_audit.md](archive/pilot_00405B40_audit.md) — ClampVehicleAttitudeLimits (0x00405B40)
- [pilot_00405D70_audit.md](archive/pilot_00405D70_audit.md) — ResetVehicleActorState (0x00405D70)
- [pilot_00405E80_audit.md](archive/pilot_00405E80_audit.md) — IntegrateVehiclePoseAndContacts (0x00405E80)
- [pilot_004063A0_audit.md](archive/pilot_004063A0_audit.md) — UpdateVehiclePoseFromPhysicsState (0x004063A0)
- [pilot_00406650_audit.md](archive/pilot_00406650_audit.md) — UpdateVehicleActor (0x00406650)
- [pilot_00406980_audit.md](archive/pilot_00406980_audit.md) — ApplyTrackSurfaceForceToActor / WallResponse (0x00406980)
- [pilot_00409150_audit.md](archive/pilot_00409150_audit.md) — ResolveVehicleContacts (0x00409150)
- [pilot_0040A720_audit.md](archive/pilot_0040A720_audit.md) — AngleFromVector12 (0x0040A720)
- [pilot_0042EB10_audit.md](archive/pilot_0042EB10_audit.md) — TransformShortVec3ByRenderMatrixRounded (0x0042EB10)
- [pilot_0042EBF0_audit.md](archive/pilot_0042EBF0_audit.md) — ComputeVehicleSurfaceNormalAndGravity (0x0042EBF0)
- [pilot_0042F030_audit.md](archive/pilot_0042F030_audit.md) — ComputeDriveTorqueFromGearCurve (0x0042F030)
- [pilot_00432D60_audit.md](archive/pilot_00432D60_audit.md) — ComputeAIRubberBandThrottle (0x00432D60)
- [pilot_00432E60_audit.md](archive/pilot_00432E60_audit.md) — InitializeRaceActorRuntime (0x00432E60)
- [pilot_004340C0_audit.md](archive/pilot_004340C0_audit.md) — UpdateActorSteeringBias (0x004340C0)
- [pilot_00434350_audit.md](archive/pilot_00434350_audit.md) — InitializeActorTrackPose (0x00434350)
- [pilot_00434FE0_audit.md](archive/pilot_00434FE0_audit.md) — UpdateActorTrackBehavior (0x00434FE0)
- [pilot_00436A70_audit.md](archive/pilot_00436A70_audit.md) — UpdateRaceActors (0x00436A70)
- [pilot_004370A0_audit.md](archive/pilot_004370A0_audit.md) — AdvanceActorTrackScript (0x004370A0)
- [pilot_004370A0_runbook.md](archive/pilot_004370A0_runbook.md) — AdvanceActorTrackScript runbook
- [pilot_004440F0_audit.md](archive/pilot_004440F0_audit.md) — UpdateActorTrackPosition (0x004440F0)
- [pilot_spline_target_audit.md](archive/pilot_spline_target_audit.md) — ComputeSignedTrackOffset (0x00434670) + SampleTrackTargetPoint (0x00434800)
- [pilot_traffic_audit.md](archive/pilot_traffic_audit.md) — ApplyDampedSuspensionForce (0x004437C0) + IntegrateVehicleFrictionForces (0x004438F0)
- [pilot_trig_audit.md](archive/pilot_trig_audit.md) — CosFloat12bit (0x0040A6A0) + SinFloat12bit (0x0040A6C0)
- [pilot_v2v_contact_audit.md](archive/pilot_v2v_contact_audit.md) — V2V contact pair (0x00408570 + 0x00408A60)
- [pilot_v2v_impulse_audit.md](archive/pilot_v2v_impulse_audit.md) — V2V impulse branches (0x004079C0)
...
- [check_agent_phase5_report.md](archive/l5_audit_reports/check_agent_phase5_report.md) — Phase 5 check + finalization verification
- [check_agent_report.md](archive/l5_audit_reports/check_agent_report.md) — L4→L5 parallel sweep verification
- [agent_5c_frontend.md](archive/l5_audit_reports/agent_5c_frontend.md) — td5_frontend.c L5 audit (Phase 5c)
- [agent_5d_render.md](archive/l5_audit_reports/agent_5d_render.md) — td5_render.c/.h L4→L5 audit (Phase 5d)
- [agent_5e1_cam_vfx.md](archive/l5_audit_reports/agent_5e1_cam_vfx.md) — td5_camera.c + td5_vfx.c L4→L5 audit (Phase 5e)
- [agent_5e2_misc.md](archive/l5_audit_reports/agent_5e2_misc.md) — HUD / asset / input / sound L5 audit (Phase 5e pt2)
- [agent_a_frontend.md](archive/l5_audit_reports/agent_a_frontend.md) — td5_frontend.c L5 audit (Agent A)
- [agent_b_render.md](archive/l5_audit_reports/agent_b_render.md) — render module L4→L5 audit (Agent B)
- [agent_c_visual.md](archive/l5_audit_reports/agent_c_visual.md) — camera / vfx / hud L5 audit (Agent C)
- [agent_d_misc.md](archive/l5_audit_reports/agent_d_misc.md) — misc modules L4→L5 audit (Agent D)
...
- [README.md](archive/followup_sessions/README.md) — eight self-contained follow-up session briefs (2026-05-22), index
- [session_01_ai_stuck_span_137.md](archive/followup_sessions/session_01_ai_stuck_span_137.md) — AI stuck at Edinburgh span 137-147
- [session_02_rotation_matrix_fpu.md](archive/followup_sessions/session_02_rotation_matrix_fpu.md) — FPU-faithful rotation matrix rebuild (root of countdown cascade)
- [session_03_rand_call_sequence.md](archive/followup_sessions/session_03_rand_call_sequence.md) — InitializeRaceSeriesSchedule rand() call-sequence alignment
- [session_04_visual_capture.md](archive/followup_sessions/session_04_visual_capture.md) — visual side-by-side capture (floating cars + HUD transparency)
- [session_05_suspension_fr_asymmetry.md](archive/followup_sessions/session_05_suspension_fr_asymmetry.md) — F-R suspension asymmetry (car tilted right)
- [session_06_invisible_walls.md](archive/followup_sessions/session_06_invisible_walls.md) — Edinburgh span 350 + Newcastle span 216 invisible walls
- [session_07_wall_recovery_exit.md](archive/followup_sessions/session_07_wall_recovery_exit.md) — AI wall-collision recovery exit conditions
- [session_08_deferred_triage.md](archive/followup_sessions/session_08_deferred_triage.md) — triage of older deferred items
- [wave1_a_quickwin_audits.md](archive/followup_sessions/wave1_a_quickwin_audits.md) — Wave 1 Agent A: quick-win audits
- [wave1_b_dispatch_tables.md](archive/followup_sessions/wave1_b_dispatch_tables.md) — Wave 1 Agent B: dispatch table inventory
- [wave1_c_switch_orphans.md](archive/followup_sessions/wave1_c_switch_orphans.md) — Wave 1 Agent C: switch-table orphan recovery
- [wave1_d_m2dx_inventory.md](archive/followup_sessions/wave1_d_m2dx_inventory.md) — Wave 1 Agent D: M2DX.dll inventory
- [wave1_e_data_segment_map.md](archive/followup_sessions/wave1_e_data_segment_map.md) — Wave 1 Agent E: .data segment map
- [wave1_f_overview.md](archive/followup_sessions/wave1_f_overview.md) — Wave 1 Agent F: wave-2 worklist outputs
- [wave3_lang_m2dxfx_inventory.md](archive/followup_sessions/wave3_lang_m2dxfx_inventory.md) — Wave 3: Language.dll + M2DXFX.dll inventory
- [wave3_locals_correlator_report.md](archive/followup_sessions/wave3_locals_correlator_report.md) — Wave 3 locals correlator report
- [wave3_m2dx_plan_summary.md](archive/followup_sessions/wave3_m2dx_plan_summary.md) — Wave 3 Agent A: M2DX.dll plate-comment apply plan
- [_index.md](archive/followup_sessions/wave3_structs/_index.md) — Tier1-B struct recovery index (2026-05-22)
