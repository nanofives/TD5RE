...
| G3 | td5_game.h migration + extern paydown | wip fix-refactor-g3-camera-externs | SLICE 5 (in progress): td5_camera.c extern paydown 7->0. 3 redundant deletes (g_replay_mode/g_actor_table_base/g_game_type -- all in td5_game.h, included); 4 add-to-header+delete (g_actorSlotForView + g_actorBaseAddr -> td5_game.h, g_actor_near_wall -> td5_physics.h, g_renderBasisMatrix -> td5_render.h). Pure decl relocation; build+lint verifies, no launch. PRIOR: hud.c 22->0, game.c 14->2, vfx.c 8->0, extern_in_c_total 103->59
